...
public class Main {
    ...
    public static void partOmission() {
        System.out.println("--Your command center--");
            System.out.println("Scan, Search, 'Engage' Ultra-Protective Firewall, or start 'Message Mission: ");
            String commandCenter = scanner.nextLine();
            if (commandCenter.equals("Message Mission")) {
                System.out.println("Mission Started.");
            } else if (commandCenter.equals("Engage")) {
                System.out.println("Firewall engaged");
            } else if (commandCenter.equals("Search")) {
                System.out.println("Searching the web and other locations for info...");
                if (key1 == 1) {  
